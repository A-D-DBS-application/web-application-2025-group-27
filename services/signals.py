...
{{
  "signals": [
    {{
      "signal_type": "headcount_change" | "industry_shift" | "hiring_shift" | "market_expansion" | "strategic_change",
...
def get_competitor_signals(company: Company) -> list:
    """Get all competitor signals for a company."""
    if not company:
        return []
    return list(
        CompanySignal.query
